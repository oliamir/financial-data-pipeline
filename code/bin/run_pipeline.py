...
def main():
    ...
    parser.add_argument('--agent', type=str, help='Subagent persona (e.g. data-analyst)')
    ...
    if should_download:
        years_arg = "5" if args.years == "all" else args.years
        cmd_download = [
            venv_python,
    ...
    if not args.skip_analyze:
        ...
        if args.agent:
            cmd_analyze.extend(["--agent", args.agent])
